    ...
    self.TypeList = ko.observableArray([
        ...
        new TypeList(3, '可充电锂电池', 'am-icon-gears', [
            new infoList(1, 'LCO-LiCoO2', [
                ...
                new ProDetail(2, 'LCO_LiCoO2_MP.jpg', 'MP, 小型 VL', '型棱柱状 MP 电池和小型圆柱状 VL 可充电电池以我们独特的锂离子技术为基础。它们能够提供高标称容量和长循环寿命，更值得称道的是，它们可以在广泛的温度范围内充放电，尤其是在低温环境中。<br>MP 和 VL 锂离子电池具有特定的冗余安全特性，即电子保护电路、充电状态和健康状态指示器、在充电器故障时使用的内置断路器、关机分离器和安全通风口，因而非常适合要求严苛的设备。', ['广泛的温度范围（无与伦比的低温性能，特定电池能够耐受 +125°C 高温）', '结构坚固，能够满足工业和国防设备的严苛环境要求', '高电流能力', '自动工作时间更长', '长循环寿命（600至2500次以上的循环），取决于环境条件', '根据我们独特的电化学技术，提供便捷的充电状态/健康状态指示器', '重量轻', '能够容易地集成至紧凑系统中', '出色的安全记录'], ['标称电压：3.6V-3.75V', '能量密度：高达385瓦时/升和180瓦时/千克', '容量范围：2.6 至 6.8Ah', '标准电池的工作温度：充电时 -20°C 至 +60°C，放电时 -50°C 至 +60°C。特定的高温电池可承受 +125°C 高温。', '一些 MP 电池符合防爆设备的 IEC60079-11 内在安全要求', '符合欧盟 RoHS 指令'], [new segmentMarket(1, '安全系统', 'security_systems.png'), new segmentMarket(2, '国防', 'defense.png'), new segmentMarket(3, '医疗用具', 'Medical_devices.png'), new segmentMarket(4, '云', 'cloud.png'), new segmentMarket(5, '计量器', 'metering.png')])
            ]),
            new infoList(2, 'LTO-Li4Ti5O12', [
                new ProDetail(1, 'LCO-LiCoO2_28v.jpg', '28V 航天级电池系统', '28V 航天级电池能够满足各类太空应用的功率和能源需求。它采用经验证的帅福得锂离子技术。作为一款小体积、免维护能源存储装置，它在上千次的循环过程中运行可靠，能效优异，是要求高功率密度和中等能量密度的太空应用的理想选择。', ['牢固的机械装配，能够承受发射器的极大冲击（1300G）和随机振动（40 Grms）', '不间断放电路径，适用于飞行终止应用', '单独的充电路径，提供过充检测/预防功能', '内置加热器，能够调节工作中电池的温度', '成熟的公司自有测试设备和能力，为验收和/或认证测试提供有力支持'], ['标称电压：28V', '容量： 3Ah', '最大充电电压：32.8V', '最大连续放电电流：30A'], [new segmentMarket(1, '航天飞机', 'space-shuttle.png')]),
            ]),
            new infoList(3, 'NCA-LiNiCoAlO2', [
                new ProDetail(1, 'NCA-LiNiCoAlO2_dagonglv.jpg', '大功率锂电池箱', '大功率锂电池箱（LBB）的基础是为美国军队 TOW 导弹的改进型目标捕获系统（ITAS）开发的 28V 锂电池箱，其参数为 28V、100安培/小时，由多个高能量锂离子电池按照 2p8s 配置组合而成。大功率锂电池箱的设计是作为一种便携式能量存储解决方案，提供备用电源和输出电源。它包括一个人机接口、嵌入式管理软件，以及多个电子防护和热熔丝等安全配置，以避免充电器故障，在危险操作情况下保护电池。', ['免维护', '重量轻', '充电快', '无需通风', '内置加热器', '联合国测试认证'], ['标称电压：28V', '标称容量：100Ah', '最大放电率：100A', '最大充电率：25A'], [new segmentMarket(1, '国防', 'defense.png')]),
                new ProDetail(2, 'NCA-NCA-LiNiCoAlO2_250V.jpg', '250/500 kW 电池系统', '对于需要高脉冲功率的单向能量和其它设备而言，帅福得提供可扩展的紧凑型250至500千瓦电池系统。250千瓦电池系统能够组合成更大功率的500千瓦、750千瓦和更高等级的系统，每个系统均可单独输出250千瓦功率。对于通用原子公司和雷神公司等使用激光设备的客户而言，这种超大功率电池系统使用寿命长，运行安全可靠。', ['超大功率', '可灵活扩展至500千瓦甚至更高等级', '紧凑型设计', '生命周期成本低', '安全可靠', '使用寿命长'], ['标称电压（50% 充电状态）：335V', '充电限制：394V', '放电限制：260V', '电池能量：8千瓦时'], [new segmentMarket(1, '国防', 'defense.png')]),
                new ProDetail(3, 'NCA-NCA-LiNiCoAlO2_28V.jpg', '28 V LBB, ITAS', '28V 锂电池箱（LBB）是一个由高能量锂离子电池构成的能量存储系统，能够在极端温度下提供高密度能量，且生命周期成本低。该系统最初是为美国军队 TOW 导弹的改进型目标捕获系统（ITAS）开发的，用于替代传统技术，以改进能耗和总拥有成本。<br><br>该电池系统包括一个人机接口、嵌入式管理软件，以及多个电子防护和热熔丝等安全配置，以避免充电器故障，在危险操作情况下保护电池。', ['免维护', '重量轻', '充电快', '无需通风'], ['标称电压：28V', '标称容量：80Ah', '最大放电率：30A'], [new segmentMarket(1, '国防', 'defense.png')]),
                new ProDetail(4, 'NCA-NCA-LiNiCoAlO2_28v_ups.jpg', '28V UPS 电源', '28V UPS 电源包括以 2p8s 方式组合的大功率模块，适用于国防和海军等工作温度要求高的应用。我们能够提供完整的定制能量存储系统，可以满足客户的特定需求。', ['获得 S9310-AQ-SAF-010 NAVSEA 锂离子电池安全批准', '可在+70°C 条件下工作2年', '大功率', '无需通风', '低生命周期成本', '安全可靠'], ['标称电压：28V', '+25°C条件下的标称容量：34Ah', '能量（C/3）：950瓦时/千克', '工作温度：-30°C 至 +70°C'], [new segmentMarket(1, '国防', 'defense.png')]),
                ...
                new ProDetail(6, 'LiNiCoAlO2_Evolion.png', '<di style="font-weight:bold;"v>Evolion® 经验证的适用于在网和离网设备的超紧凑型解决方案</div><br><br>如果你使用的电网不可靠，经常断电，那么你就需要备用电源解决方案，以确保为终端用户提供连续的电信服务，无论你的设备在室内还是室外，在网还是离网，处于炎热或严寒地区，位于身边还是偏远地区。', '经验证的适用于在网和离网设备的超紧凑型解决方案</em><br><br>如果你使用的电网不可靠，经常断电，那么你就需要备用电源解决方案，以确保为终端用户提供连续的电信服务，无论你的设备在室内还是室外，在网还是离网，处于炎热或严寒地区，位于身边还是偏远地区。<br><br>Evolion® 是一个高效、安全、可靠的备用电源，将浮充和高循环性能结合，是独一无二的。Evolion® 结构紧凑，体积轻便，易于安装，能够在有限的空间内最大程度地提供备用能量，确保总拥有成本最低。', ['牢固的机械装配，能够承受发射器的极大冲击（1300G）和随机振动（40 Grms）', '不间断放电路径，适用于飞行终止应用', '单独的充电路径，提供过充检测/预防功能', '内置加热器，能够调节工作中电池的温度', '成熟的公司自有测试设备和能力，为验收和/或认证测试提供有力支持'], ['标称电压：28V', '容量： 3Ah', '最大充电电压：32.8V', '最大连续放电电流：30A'], [new segmentMarket(1, '信号塔', 'TelecomTower.png')]),
            ]),
